...
isEmptyCertificateStore (CertificateStore m) = ETT__.t "Data.X509.CertificateStore.isEmptyCertificateStore" ETT__.$ M.null m
isEmptyCertificateStore (CertificateStores []) = ETT__.t "Data.X509.CertificateStore.isEmptyCertificateStore" ETT__.$ True
isEmptyCertificateStore _ = ETT__.t "Data.X509.CertificateStore.isEmptyCertificateStore" ETT__.$ False
...
append s1@(CertificateStore _) s2@(CertificateStore _) = ETT__.t "Data.X509.CertificateStore.append" ETT__.$ CertificateStores [s1, s2]
append (CertificateStores l) s2@(CertificateStore _) = ETT__.t "Data.X509.CertificateStore.append" ETT__.$ CertificateStores (l ++ [s2])
append s1@(CertificateStore _) (CertificateStores l) = ETT__.t "Data.X509.CertificateStore.append" ETT__.$ CertificateStores ([s1] ++ l)
append (CertificateStores l1) (CertificateStores l2) = ETT__.t "Data.X509.CertificateStore.append" ETT__.$ CertificateStores (l1 ++ l2)

-- | Create a certificate store out of a list of X509 certificate
makeCertificateStore :: [SignedCertificate] -> CertificateStore
makeCertificateStore = ETT__.t "Data.X509.CertificateStore.makeCertificateStore" ETT__.$ CertificateStore . foldl' accumulate M.empty
  where
...
findCertificate dn store = ETT__.t "Data.X509.CertificateStore.findCertificate" ETT__.$ lookupIn store
  where
...
listCertificates (CertificateStore store) = ETT__.t "Data.X509.CertificateStore.listCertificates" ETT__.$ map snd $ M.toList store
listCertificates (CertificateStores l) = ETT__.t "Data.X509.CertificateStore.listCertificates" ETT__.$ concatMap listCertificates l
...
readCertificateStore path = ETT__.tio "Data.X509.CertificateStore.readCertificateStore" ETT__.$ do
...
readCertificates file = ETT__.tio "Data.X509.CertificateStore.readCertificates" ETT__.$
    E.catch
...
listDirectoryCerts path = ETT__.tio "Data.X509.CertificateStore.listDirectoryCerts" ETT__.$
